# cv_processor/analysis/template_analyzer.py
"""
...
def read_template_full_text(template_path: str = TEMPLATE_PATH) -> str:
...
def analyze_template_schema(template_text: str | None = None) -> List[Dict[str, Any]]:
