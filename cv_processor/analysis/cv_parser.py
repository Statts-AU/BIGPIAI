# cv_processor/analysis/cv_parser.py
"""
...
from cv_processor.config.settings import CONTENT_DIR
from cv_processor.utils.ai_client import analyze_with_ai, parse_with_ai
...
def extract_raw_cv_text(content_dir: str = CONTENT_DIR) -> List[Tuple[str, str]]:
...
def build_source_profile() -> Dict[str, Any]:
